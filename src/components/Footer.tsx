...
const SOCIAL_LINKS = [
  ...
  { label: "X / Twitter", path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
...
const FOOTER_LINKS = ["Privacy Policy", "Terms of Service", "Cookies Settings"];

export function Footer() {
  return (
    <footer className="border-t border-gray-100 dark:border-gray-800
                       px-4 md:px-8 lg:px-12 pt-10 pb-6">

      {/* Top — stacks on mobile, 4 col on desktop */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <FooterColumn label="Phone Number">
          1800 123 4567
        </FooterColumn>
